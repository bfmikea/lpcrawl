...
function bttowp_theme_styles(){
    ...
    wp_enqueue_style( 'theme_css', get_template_directory_uri() . '/css/theme-vendors.css' );
...
function bttowp_theme_js(){
    ...
    // main bootstrap js
    wp_enqueue_script( 'jquery_js', get_template_directory_uri() . '/js/jquery-3.2.0.min.js', array( 'jquery' ), '', true );
